...
public class UpdateWorkflowStatusHandler extends AbstractRequestHandler<Boolean> {
    ...
    public UpdateWorkflowStatusHandler(BigInteger id) {
    ...
    protected Boolean doExecute() {
        ApiResult<Object> result = client.updateWorkFlowStatus(statusDTO);
     ...
     *
     */
    public UpdateWorkflowStatusHandler setStatus(Boolean yesOrNoStatus) {
